...
@section('right')
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading">修改教练</div>
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/coach/edit') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            <input id="name" type="text" class="form-control" name="name" value="{{ $coach->name }}" required>
                        </div>
                    </div>
                            ...
                            <select name="classify" id="classify" class="form-control">
                                @if(isset($classifies))
                                    @foreach($classifies as $classify)
                                        <option @if($classify->id == $coach->classify_id) selected @endif value="{{ $classify->id }}">{{ $classify->name }}</option>
                                    @endforeach
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="synopsis" type="text" class="form-control" name="synopsis" value="{{ $coach->synopsis }}" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            <textarea class="form-control" rows="5" id="descript" name="descript" required>{!! $coach->descript !!}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="rect" id="f-rect" value="{{ $coach->rect_picture }}" readonly>
                        </div>
                        <div class="col-md-1">
                            <a href="{{ url($coach->rect_picture) }}" data-show="rect" class="btn btn-default" target="view_frame">查看</a>
                        </div>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="square" id="f-square" value="{{ $coach->square_picture }}" readonly>
                        </div>
                        <div class="col-md-1">
                            <a href="{{ url($coach->square_picture) }}" data-show="square" class="btn btn-default" target="view_frame">查看</a>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-9 col-md-offset-1">
                            <div class="btn btn-success z-upload" data-name="rect">更换竖型照片</div>
                            <div class="btn btn-success z-upload" data-name="square">更换正方形照片</div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-1">
                            ...
                            <a href="{{ url('/backstage/coachlist') }}" class="btn btn-default">返回</a>
                        </div>
                    </div>
                </form>
