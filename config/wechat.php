...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wxa8bc2f9a84584844'),         // AppID
    'secret'  => env('WECHAT_SECRET', '64e155f8d04f357fc5f3414a4528946d'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'Lucky'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'pA38TApLoCJEZ7fvkVZNTnjOG9jTkCFaruSB9htphev'),                    // EncodingAESKey
